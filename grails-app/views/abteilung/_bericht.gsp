...
%>
<g:render template="/global/ui/accordion/accordionTabAbteilung" model="[itemName: 'bericht', item: bericht, abteilung: abteilung, accordionTabUeberschrift1: bericht.ueberschrift, text: bericht.inhalt, datum: bericht.lastUpdated, isEditable: true, params: params]" />
