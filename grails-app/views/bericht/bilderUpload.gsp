												...
												<table>
													<tr>
														<shiro:hasRole name="${ShiroRole.BENUTZER}">
															<td>
																<g:link controller="picture" action="edit" params="[id: pictureInstance.id, albumId: album.id, 'bericht.id': bericht.id]"><img src="${resource(dir: '/images/skin', file: 'database_edit.png')}" alt="Termin ändern" title="Termin ändern" border="0"/></g:link>
																<jq:jquery>
