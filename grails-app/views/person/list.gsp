    ...
    <body>
        ...
        <div class="body">
			...
			<g:if test="${personInstanceTotal > 0}">
				...
				<div>
					<span>
						<g:pdfLink url="/export/pdfExport" filename="Adressenliste" class="pdf_link">Adressenliste PDF-Export</g:pdfLink>
					</span>
					<span style="margin-left: 20px;">
						<g:link controller="export" action="excelExport" params="[fileName: 'Adressenliste']" class="excel_link">Adressenliste Excel-Export</g:link>
					</span>
				</div>
			</g:if>
        </div>
